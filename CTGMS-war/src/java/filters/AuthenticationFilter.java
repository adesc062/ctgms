...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (reqURI.contains("/requester/") && (ses == null || (ses != null && ses.getAttribute("Requester") == null))) {
            String loginURL = req.getContextPath() + "/faces/SignInScreen.xhtml";
            res.sendRedirect(loginURL);
        }
        else if (reqURI.contains("/supervisor/") && (ses == null || (ses != null && ses.getAttribute("Supervisor") == null))) {
            String loginURL = req.getContextPath() + "/faces/SignInScreen.xhtml";
            res.sendRedirect(loginURL);
        } else {
