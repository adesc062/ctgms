...
public void setup(String requestedChanges, Supervisor supervisor) {     
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SupervisorRecommendation)) {
            return false;
        }
        SupervisorRecommendation other = (SupervisorRecommendation) object;
    ...
    /**
     * @param requestedChanges the requestedChanges to set
     */
